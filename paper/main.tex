...
% ---- Project page. Edit this one line: it feeds both the title-page footnote and
% Appendix "Reproducibility". ----
\newcommand{\projecturl}{https://github.com/dingningpei/slowlab-benchmark}

\title{\slowlab: Benchmarking Scientific Agents When Experiments Are\\
Slow, Noisy, Costly, and Irreversible}

\author{%
  Ningpei Ding\thanks{Project: \url{\projecturl}}
  \\[2pt]
  \todo{affiliation}
}
\date{}
...
\input{sections/02_regime}
\input{sections/05_tasks_metrics}
